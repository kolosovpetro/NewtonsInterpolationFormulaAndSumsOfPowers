...
\begin{theorem}[Ordinary sums of powers via Newton's series]
    \label{theorem:ordinary-sums-of-powers-via-newtons-series}
    \begin{mdframed}
...
The formula above is essentially identical to~\eqref{theorem:ordinary-sums-of-powers-via-newtons-series}.
Let be a conjecture
\begin{conjecture}
    \begin{align*}
    ...
    \end{align*}
\end{conjecture}
By considering the special cases of the theorem~\eqref{theorem:ordinary-sums-of-powers-via-newtons-series} for $t=4$,
...
\end{align*}
Thus,
\begin{theorem}[Double sums of powers via finite difference 2]
    \begin{mdframed}
        \begin{align*}
