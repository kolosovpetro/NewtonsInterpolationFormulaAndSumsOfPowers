...
The formula above is essentially identical to~\eqref{prop:ordinary-sums-of-powers-via-newtons-series},
which yields the identity for finite differences $\Delta^{j} t^m = j! \stirlingii{m}{j}_{t}$.
