...
\begin{proposition}[Segmented Hockey stick identity]
    ...
    \end{mdframed}
    \begin{proof}
        See section~\eqref{sec:proof-of-segmented-hockey-stick-identity}.
    \end{proof}
\end{proposition}
Hence,
\begin{align*}
...
Interestingly enough that the paper~\cite{cereceda2022sums} gives formula for sums of powers
...
The formula above is identical to 
proposition~\eqref{prop:ordinary-sums-of-powers-via-newtons-series},
which implies that finite differences can be expressed 
...
sum of powers~\eqref{prop:ordinary-sums-of-powers-via-newtons-series} again,
thus
\begin{align*}
...
\begin{proposition}[Triple sums of powers via Newton's series]
    ...
    \begin{proof}
        ...
        powers~\eqref{prop:double-sums-of-powers-via-newtons-series}, 
        we get
        \begin{align*}
            \KnuthRFoldSum{3}{n}{m} 
            &= \sum_{j=0}^{m} \Delta^{j} t^m \sum_{k=1}^{n}  \left[ (-1)^{j} \binom{j+t-1}{j+1} k^1 + (-1)^{j+1} \binom{j+t-1}{j+2} k^0 + \binom{k-t+2}{j+2} \right] \\
...
\begin{theorem}[Multifold sums of powers via Newton's series]
    ...
    \begin{mdframed}
        ...
        \begin{align*}
            \KnuthRFoldSum{r}{n}{m} 
            = \sum_{j=0}^{m} \Delta^{j} t^{m} \left[ \binom{n-t+r}{j+r} + \sum_{s=1}^{r} (-1)^{j+s-1} \binom{j+t-1}{j+s} \KnuthRFoldSum{r-s}{n}{0} \right]
        \end{align*}
    \end{mdframed}
    \begin{proof}
...
\begin{example}[Explicit expansion of the $s$--sum in the $r$-fold case]
...
\begin{proposition}[Multifold sums of powers binomial form]
    ...
    \begin{mdframed}
        ...
        \begin{align*}
            \KnuthRFoldSum{r}{n}{m} 
            = \sum_{j=0}^{m} \Delta^{j} t^{m} \left[ \binom{n-t+r}{j+r} + \sum_{s=1}^{r} (-1)^{j+s-1} \binom{j+t-1}{j+s} \binom{r-s+n-1}{r-s} \right]
        \end{align*}
    \end{mdframed}
\end{proposition}
