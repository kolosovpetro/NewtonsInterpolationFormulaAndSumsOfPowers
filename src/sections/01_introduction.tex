...
\begin{corollary}[Multifold sums of powers binomial form]
    For non-negative integers $r,n$ and $m$
    \begin{align*}
    ...
    \end{align*}
\end{corollary}
\begin{corollary}[Multifold sums of powers binomial form reindexed]
    For non-negative integers $r,n$ and $m$
    \begin{align*}
