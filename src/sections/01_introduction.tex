...
\begin{proposition}[Newton series for power]
...
\end{align*}
The coefficients $1,7,12,6,1,15, \dots$ are given by the sequence [ID] in the OEIS~\cite{sloane2003line}.
...
\begin{theorem}[Multifold sums of powers via Newton's series]
    \label{theorem:multifold-sums-of-powers-via-newtons-series}
        ...
        \end{align*}
    \begin{proof}
        By Newton series for monomial reversed~\eqref{prop:newton-series-for-monomial-reversed} and repeated
        segmented hockey stick identity~\eqref{prop:segmented-hockey-stick-identity}.
    \end{proof}
%    \begin{validate}
%        r = 3; Table[MultifoldSumOfPowersRecurrence[r, n, m] - RFoldSumViaAlternatingBinomialCorrectionTerm[r, n, m, t], {n, 0, 10}, {m, 1, 10}, {t, 0, n}] // Flatten
%    \end{validate}
\end{theorem}
