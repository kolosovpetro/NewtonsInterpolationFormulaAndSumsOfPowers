...
\input{sections/03_auxiliary_lemmas.tex}
...
\input{sections/07_backward_difference_form.tex}

\section{Central difference form}
\input{sections/08_central_difference_form.tex}
...
\input{sections/11_mathematica.tex}
