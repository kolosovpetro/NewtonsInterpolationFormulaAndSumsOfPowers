...
%    \tableofcontents
    ...
    \section{Proof of Segmented hockey stick identity}\label{sec:proof-of-segmented-hockey-stick-identity}
    \input{sections/02_proof_of_segmented_hockey_stick_identity}
